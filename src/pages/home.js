    ...
    render() {
        return (
            <div>
                ...
                <div style={{ marginLeft: "4%", marginRight: "4%", padding: "15px", marginTop: "100px" }}>
                    <Row>
                        <Col>
                            <Card style={{ height: "28rem", border: "1px solid rgb(39, 134, 44, 0.8)" }}>
                                ...
                                <Card.Body>
                                    <Card.Title style={{ fontFamily: "'Roboto', sans-serif", fontWeight: "bold" }}>Weight loss and maintain</Card.Title>
                        ...
                        <Col>
                            <Card style={{ height: "28rem", border: "1px solid rgb(39, 134, 44, 0.8)" }}>
                                ...
                                <Card.Body>
                                    <Card.Title style={{ fontFamily: "'Roboto', sans-serif", fontWeight: "bold" }}>Blood pressure control</Card.Title>
                                    <Card.Text style={{ fontFamily: "'Style Script',cursive", fontSize: "16px" }}>
                ...
                <div style={{ background: "#ffffff url(//www.ruled.me/wp-content/themes/genesis-child/sections/homepage/img/divider.png) no-repeat scroll 0 0 / 100% 100%", height: "10rem", marginTop: "30px", marginBottom: "70px" }}>
                    <h1 style={{ textAlign: "center", padding: "55px", marginLeft: "4%", fontFamily: "'Style Script', cursive", color: "whitesmoke" }}>Keto Diet Success Stories</h1>
                </div>
                <div>
                    <Carousel style={{ marginLeft: "13%", marginTop: "20px", marginBottom: "30px", width: "75%" }}>
                        <Carousel.Item>
                            <img style={{ height: "450px", width: "100px" }}
                                className="d-block w-100"
                                src="https://cdn.ruled.me/wp-content/uploads/2019/10/ElenaJuarez_SuccessBody.jpg"
                                alt="Third slide"
                            />

                            <Carousel.Caption style={{ backgroundColor: "rgba(255,255,255,0.5)", marginTop: "20px", color: "black" }}>
                                <h3>ELENA HAS LOST OVER 80 POUNDS ON KETO</h3>
                                <p style={{ fontFamily: "'Style Script',cursive", fontSize: "16px" }}>Like so many others, I've started over so many more times than I can count. I've tried everything under the sun to lose weight and was successful the year before I got married because I knew it was fast approaching. But I kept my diet super low in carbs and hours and hours at the gym to get there only to gain that weight back after I had my girls (within 3 years). After that, I would yo-yo diet. This time was different, my 9-year-old received a letter from her school saying she had to be ...</p>
                            </Carousel.Caption>
                        </Carousel.Item>
                        <Carousel.Item>
                            <img style={{ height: "450px", width: "100px" }}
